These files contain different analysis that can be done on BC1 Look Up Table seq data (mostly Map1) to give you more information or help troubleshooting. 
